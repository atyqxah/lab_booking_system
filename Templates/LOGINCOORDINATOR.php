...
if (isset($_POST['USERID'])) {
  ...
  $MM_redirectLoginSuccess = "COORDINATORMENU.php";
  $MM_redirectLoginFailed = "LOGINCOORDINATOR.php";
  $MM_redirecttoReferrer = true;
  mysql_select_db($database_dbcon, $dbcon);
  
  $LoginRS__query=sprintf("SELECT C_ID_NUMBER, C_PASSWORD FROM it_coordinator WHERE C_ID_NUMBER=%s AND C_PASSWORD=%s",
...
<div id="apDiv1">
  ...
  <div id="apDiv3">
    <table width="200" height="51" border="1">
      <tr>
