...
if ((isset($_GET['USER_ID_NUMBER'])) && ($_GET['USER_ID_NUMBER'] != "")) {
  $deleteSQL = sprintf("DELETE FROM non_utm_registration WHERE USER_ID_NUMBER=%s",
                       GetSQLValueString($_GET['USER_ID_NUMBER'], "text"));

  mysql_select_db($database_dbcon, $dbcon);
  $Result1 = mysql_query($deleteSQL, $dbcon) or die(mysql_error());

  $deleteGoTo = "UTMUSERRECORDADMIN.php";
