...
<div id="apDiv4">
  <table border="1">
    <tr>
      ...
      <td bgcolor="#FF99CC">IT_LAB_NAME</td>
  ...
  <tbody id="myTable">
    <?php do { ?>
      <tr>
        ...
        <td bgcolor="#FF99CC"><?php echo $row_Record8['IT_LAB_NAME']; ?></td>
        ...
        <td bgcolor="#FF99CC"><a href="COORDINATORSTATUSUTM.php?ID_NUMBER=<?php echo $row_Record8['ID_NUMBER']; ?>">STATUS</a></td>
      </tr>
