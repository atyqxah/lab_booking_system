...
<body>
<div id="apDiv1"><strong>BOOKING RECORD</strong></div>
<div id="apDiv3">
...
<div id="apDiv4">
  <table border="1">
    ...
    <?php do { ?>
      <tr>
        <td bgcolor="#FFCCFF"><?php echo $row_Recordset1['IT_LAB_ID']; ?></td>
        ...
        <td bgcolor="#FFCCFF"><?php echo $row_Recordset1['NUMBER_OF_PARTICIPANTS']; ?></td>
        <td bgcolor="#FFCCFF"><?php echo $row_Recordset1['ITNOT']; ?></td>
        <td bgcolor="#FFCCFF"><?php echo $row_Recordset1['USER_ID_NUMBER']; ?></td>
        <td bgcolor="#FFCCFF"><?php echo $row_Recordset1['ID_NUMBER']; ?></td>
        <td bgcolor="#FFCCFF"><a href="COORDINATORSTATUS.php">STATUS</a></td>
      </tr>
