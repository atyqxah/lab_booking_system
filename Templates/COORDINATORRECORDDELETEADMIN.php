...
if ((isset($_GET['C_ID_NUMBER'])) && ($_GET['C_ID_NUMBER'] != "")) {
  $deleteSQL = sprintf("DELETE FROM it_coordinator WHERE C_ID_NUMBER=%s",
                       GetSQLValueString($_GET['C_ID_NUMBER'], "text"));

  mysql_select_db($database_dbcon, $dbcon);
  $Result1 = mysql_query($deleteSQL, $dbcon) or die(mysql_error());

  $deleteGoTo = "COORDINATORRECORDADMIN.php";
