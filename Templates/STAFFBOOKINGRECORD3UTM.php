...
<body>
<div id="apDiv1"><strong>UTM USER BOOKING RECORD</strong></div>
<div id="apDiv3">
  ...
  <table border="1">
    ...
    <?php do { ?>
      <tr>
        ...
        <td bgcolor="#FF99CC"><?php echo $row_Record8['HOUR_USE']; ?></td>
        <td bgcolor="#FF99CC"><?php echo $row_Record8['NUMBER_OF_PARTICIPANTS']; ?></td>
        <td bgcolor="#FF99CC"><?php echo $row_Record8['ID_NUMBER']; ?></td>
        <td bgcolor="#FF99CC"><a href="STAFFBOOKINGRECORD3UTMDELETE.php?ID_NUMBER=<?php echo $row_Record8['ID_NUMBER']; ?>">DELETE</a></td>
      </tr>
      <?php } while ($row_Record8 = mysql_fetch_assoc($Record8)); ?>
  </table>
</div>
<div align="center">
  <div id="apDiv7"><a titlt="print screen" alt="print screen" onClick="window.print();"target="_blank"style="cursor:pointer;">PRINT</a></div>
</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><!DOCTYPE html>
